...
alert('End: '+bounds.end);
    ...
    showEventEditor : function(rec, animateTarget){
        this.getEventEditor(rec).show(rec, animateTarget, this);
        return this;
    },
    ...
    dismissEventEditor : function(dismissMethod, /*private*/ animTarget){
        ...
        var editWin =this.editWin || Ext.WindowMgr.get('ext-cal-editwin');
        if(editWin){
