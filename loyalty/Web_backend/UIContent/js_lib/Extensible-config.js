...
Extensible.Config = {
    ...
    writeIncludes: function() {
        ...
        me.includeStylesheet(me.extensibleRoot + 'resources/css/ext-all-gray.css');
       
        me.includeStylesheet(me.extensibleRoot + 'resources/css/extensible-all.css' + cacheBuster);
        
        me.includeStylesheet(me.extensibleRoot + 'resources/css/examples.css?_dc=' + Extensible.version);
        
        
        me.includeScript(me.extensibleRoot + 'ext' + suffix + '.js');
        //alert(me.extJsRoot + 'ext' + suffix + '.js');
        me.includeScript(me.extensibleRoot + 'extensible' + suffix + bootstrap + '.js' + cacheBuster);
        //alert(me.extensibleRoot + 'extensible' + suffix + bootstrap + '.js' + cacheBuster);
        me.includeScript(me.extensibleRoot + 'examples.js?_dc=' + Extensible.version);
        //alert(me.extensibleRoot + 'resources/examples.js?_dc=' + Extensible.version);
    }
};
