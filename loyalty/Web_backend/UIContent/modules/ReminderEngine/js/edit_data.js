Ext.define('com.palmary.reminderengine.js.edit', {
    gridPanel: undefined,
    initTag: function (tab, url, title, id, itemId) {
        ...
        form.viewForm(target_div, '../ReminderEngine/EditViewForm/' + _id);
        form.showToolBar(tool_div, '../ReminderEngine/EditView_ToolbarData/' + _id, id);
