Ext.define('com.palmary.remindertemplate.js.edit', {
    gridPanel: undefined,
    initTag: function (tab, url, title, id, itemId) {
        ...
        form.viewForm(target_div, '../ReminderTemplate/EditViewForm/' + _id);
        form.showToolBar(tool_div, '../ReminderTemplate/EditView_ToolbarData/' + _id, id);
