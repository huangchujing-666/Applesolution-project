Ext.define('com.palmary.report.js.topRedeemReport', {
    ...
    initTag: function (tab, url, title, id, itemId) {
        ...
        itemList[0].items.push({
            title: "Top Redeem Report",
            iconCls: "iconGrid",
            items: Ext.create("com.palmary.portlet.topRedeemReportPortlet"),
            linkUrl: "com.palmary.portlet.topRedeemReportPortlet",
            linkType: "grid",
            pId: "topRedeemReport",
            isClose: true,
            isCollapse: false,
