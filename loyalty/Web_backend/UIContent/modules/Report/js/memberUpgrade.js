Ext.define('com.palmary.report.js.memberUpgrade', {
    ...
    initTag: function (tab, url, title, id, itemId) {
        ...
        var tb = Ext.create('Ext.toolbar.Toolbar', {
            ...
            margin: '0 0 0 0',
            items: [
                temp_select, date_element, date_element2,
            {
                text: 'Generate',
                iconCls: 'iconReload',
                handler: function () {
        ...
        itemList[0].items.push({
            ...
            iconCls: "iconGrid",
            items: Ext.create("com.palmary.portlet.memberUpgradePortlet"),
            linkUrl: "com.palmary.portlet.memberUpgradePortlet",
            linkType: "grid",
            pId: "upgradeReport",
            isClose: true,
            isCollapse: false,
