Ext.define('com.palmary.report.js.memberGainLost', {
    ...
    initTag: function (tab, url, title, id, itemId) {
        ...
        itemList[0].items.push({
            title: "Member Gain Lost Report",
            iconCls: "iconGrid",
            items: Ext.create("com.palmary.portlet.memberGainLostPortlet"),
            linkUrl: "com.palmary.portlet.memberGainLostPortlet",
            linkType: "grid",
            pId: "memberGainLost",
            isClose: true,
            isCollapse: false,
