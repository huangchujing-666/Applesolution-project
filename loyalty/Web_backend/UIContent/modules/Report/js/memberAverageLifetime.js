Ext.define('com.palmary.report.js.memberaveragelifetime', {
    ...
    initTag: function (tab, url, title, id, itemId) {
        ...
        itemList[0].items.push({
            title: "Member Average Lifetime",
            iconCls: "iconGrid",
            items: Ext.create("com.palmary.portlet.memberAverageLifetimePortlet"),
            linkUrl: "com.palmary.portlet.memberAverageLifetimePortlet",
            linkType: "grid",
            pId: "memberAverageLifetime",
            isClose: true,
            isCollapse: false,
            closable: false,
            collapsed: false,
