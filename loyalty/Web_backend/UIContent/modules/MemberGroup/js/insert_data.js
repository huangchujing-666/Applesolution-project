Ext.define('Ext.ux.form.field.MyAddMemberGroupCriteria', {
    extend: 'Ext.form.FieldContainer',
    mixins: {
        field: 'Ext.form.field.Field'
    },
    alias: 'widget.myAddMemberGroupCriteria',
    layout: 'hbox',
    height: 22,
    cls: 'custom_field',
    ...
    addDetailRow: function (e, b) {
        var me = this;
        var fieldSet = Ext.getCmp("member_group_criteria_set");
        var now = new Date();
        var newID = now.getHours() + '' + now.getMinutes() + '' + now.getSeconds() + '' + now.getMilliseconds();
        var comp_id = "mc_criteriaRow_" + newID;
        var item3_id = 'mc_valueConnector_' + newID;
        var item4_id = 'mc_valueItem_' + newID;
        ...
        var item2 = {
            ...
            store: Ext.create('Ext.data.Store', {
                ...
                proxy: {
                    type: 'ajax',
                    url: '../PromotionRule/GetMemberColumn',
                    reader: {
                        type: 'json',
                        root: 'data'
                    }
            ...
            listeners: {
                select: function () {
                    ...
                    if (theValue == 1 || theValue == 2 || theValue == 3 || theValue == 11) {// int, float
                        var new_item3 = {
                            xtype: 'combobox',
                            id: item3_id,
                            name: item3_id,
                    ...
                    else if (theValue == 4 || theValue == 10) { //date
                        var new_item3 = {
                            xtype: 'combobox',
                            id: item3_id,
                            name: item3_id,
                    ...
                    //string
                    else if (theValue == 5 || theValue == 6 || theValue == 7 || theValue == 9 || theValue == 12 || theValue == 13 || theValue == 14 || theValue == 15) {
                        var new_item3 = {
                            xtype: 'combobox',
                            id: item3_id,
                            name: item3_id,
                    ...
                    else if (theValue == 8 || theValue == 17) { //select

                        var select_json_url = "";
                        if (theValue == 8)
                            select_json_url = "../Table/GetListItems/Gender";
                        else if (theValue == 17)
                            select_json_url = "../Table/GetListItems/Salutation";
...
Ext.define('com.palmary.membergroup.js.insert', {
	gridPanel:undefined,
	    ...
	    Ext.Ajax.request({
	        ...
	        success: function (o) {
	            ...
	            var group_fieldset_additem = {
	                ...
	                xtype: "myAddMemberGroupCriteria",
	                value: "",
	                rowspan: 1,
	                colspan: 2,
	                height: 30
