...
Ext.define('Ext.ux.multiupload.Upload', {
    ...
    height: 22,
    wmode: 'transparent',
    url: prefix_path + 'ux/multiupload/Upload.swf',
    statics: {
        instanceId: 0
    },
    constructor: function (config) {
        ...
        config.flashVars = Ext.apply({
            ...
            buttonImagePath: prefix_path + 'ux/multiupload/button.png',
            buttonImageHoverPath: prefix_path + 'ux/multiupload/button_hover.png',
