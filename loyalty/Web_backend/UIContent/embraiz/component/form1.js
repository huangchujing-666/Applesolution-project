            ...
            if (json_data.row[i].type == "currencyFormat") {
                ...
                if (json_data.row[i].value != null || json_data.row[i].value != '') {
                    if (json_data.row[i].upType == 'file') {
                        ...
                        temp_element.xtype = "displayfield";
                        temp_element.name = json_data.row[i].name;
                        temp_element.value = "<a href='" + json_data.row[i].value + "' target='_blank'>" + json_data.row[i].value + "</a>";
                    } else {
                        temp_element.fieldLabel = json_data.row[i].fieldLabel;
                        temp_element.xtype = "displayfield";
                        temp_element.name = json_data.row[i].name;
                        temp_element.value = '<img src="' + check(json_data.row[i].value) + '" />';
                ...
                if (json_data.row[i] != undefined) {
                    ...
                    if (regex != undefined && regex != '') {
                        if (regex == "emailRegex") {
                            ...
                            temp_element.regex = Ext.decode(regex);
                        }
                ...
                form_buttons = [Ext.create('Ext.Button', {
                        ...
                        if (form.isValid()) {
                            ...
                            form.getFields().each(function (item) {
                                if (item.getActiveError()) {
                                    error_msg = error_msg + item.name + ": " + item.getActiveError().replace('<ul><li class="last">', '').replace('</li></ul>', '') + '<br>';

                                }
                            });
                            Ext.Msg.alert(error_msg);
                        }
                    }
                    ...
                    handler: function () {
                        ...
                        for (ff = 0; ff < form_field.length; ff++) {
                            ...
                            if (current_field.xtype == 'timefield' || current_field.xtype == 'combofieldbox' || current_field.xtype == 'combobox' || current_field.xtype == 'boxselect' || current_field.xtype == 'comboboxselect') {
