...
Ext.define('Ext.ux.form.HtmlEditor.imageUpload', {
     ...
     */
    submitUrl: 'common/htmlEditorImageUpload.jsp',///
     ...
     */
    managerUrl: 'common/htmlEditorImageUpload.jsp',
            ...
            items: [{
                ...
                items: [{
                    ...
                    layout: {
                        ...
                        columns: 2,
                        tableAttrs: {
                            styleHtmlCls: 'upload-image-table'
                        },
                        tdAttrs:{
                        	styleHtmlCls: 'upload-image-tr'
                        }
                    },                    
                    defaults: {
                        anchor: '99%',
            ...
            form.submit({
                ...
                success: function (fp, o) {
                   ...
                   // me._setPreviewImage(o.result.data['src'], true); 
                    combo.setRawValue(o.result.src);
                    me._setPreviewImage(o.result.src, true);
                },
			...
			success: function (response) {
				...
				if(result.success)
				{
                   ...
                   // me._setPreviewImage(result.data['src'], true);
                    combo.setRawValue(result.src);
                    me._setPreviewImage(result.src, true);
