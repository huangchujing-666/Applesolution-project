...
{
    [Authorize]
    public class TransactionFieldController : Controller
    {
        private int _id;

        public TransactionFieldController()
        {
        }
        ...
        public string ViewBasicData()
        {
            ...
            var extTable = new ExtJsTable
            {
                ...
                post_url = "",
                post_header = "",
                title = "Transaction Custom Field Usage",
                icon = "iconRemarkList",
            ...
            var rowFieldInput_str = new ExtJsFieldLabelInput<string>(PayloadKeys.Dummy, "Used 0 of 100")
            {
                fieldLabel = "NVARCHAR",
                type = "input",
                colspan = 2,
