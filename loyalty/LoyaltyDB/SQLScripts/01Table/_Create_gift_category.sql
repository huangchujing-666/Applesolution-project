...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[gift_category]') AND type in (N'U'))
DROP TABLE [dbo].[gift_category]
GO
...
CREATE TABLE [dbo].[gift_category](
 ...
 CONSTRAINT [PK_gift_category] PRIMARY KEY CLUSTERED 
(
	[category_id] ASC
